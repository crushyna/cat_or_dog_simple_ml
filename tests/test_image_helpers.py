...
class TestImageHelpers:
    ...
    def test_create_image_for_ml(self):
        test_filename = 'cat_example.jpg'
        test_filename_ml = f"static/resources/temp/cat_example_ml.jpg"
        ImageHelpers.create_ml_image(test_filename, test_filename_ml)
        test_image = Image.open(test_filename_ml)
        assert test_image.size[0] == 160
        assert test_image.size[1] == 160
